...
public class DistanceMapService {
	...
	private static final String URL_ALL_LOCATION = "https://maps.googleapis.com/maps/api/distancematrix/json?units=metric&origins={lat},{lng}&destinations={destlat},{destlng}&language=pt-BR&key=" + API_KEY;
	
	public String getDistanceByLocation(SearchMapDirection location) {

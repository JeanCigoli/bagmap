...
-- Schema db_maps
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `db_maps` DEFAULT CHARACTER SET utf8 ;
USE `db_maps` ;

-- -----------------------------------------------------
-- Table `db_maps`.`tb_roles`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_maps`.`tb_roles` (
...
INSERT INTO tb_roles VALUES (null, 'ROLE_USER', NOW(), NOW());
INSERT INTO tb_roles VALUES (null, 'ROLE_ESTABLISHMENT', NOW(), NOW());
INSERT INTO tb_roles VALUES (null, 'ROLE_BRANCH', NOW(), NOW());
INSERT INTO tb_roles VALUES (null, 'ROLE_ADMIN', NOW(), NOW());

-- -----------------------------------------------------
-- Table `db_maps`.`tb_type_place`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_maps`.`tb_type_place` (
  `id_type_place` INT NOT NULL AUTO_INCREMENT,
...
INSERT INTO tb_type_place VALUES (1, 'Lugar por Usuário', 'place_user', 'https://storage.googleapis.com/bagmap-b8146.appspot.com/placeUser.png');
INSERT INTO tb_type_place VALUES (null, 'Aeroporto', 'airport', 'google');
INSERT INTO tb_type_place VALUES (null, 'Padaria', 'bakery', 'bagmap');
INSERT INTO tb_type_place VALUES (null, 'Bar', 'bar', 'bagmap');
INSERT INTO tb_type_place VALUES (null, 'Loja de bicicletas', 'bicycle_store',  'bagmap');
INSERT INTO tb_type_place VALUES (null, 'Livraria', 'book_store', 'bagmap');
INSERT INTO tb_type_place VALUES (null, 'Loja de roupas', 'clothing_store', 'bagmap');
INSERT INTO tb_type_place VALUES (null, 'Loja de conveniência', 'convenience_store', 'google');
INSERT INTO tb_type_place VALUES (null, 'Boate', 'night_club', 'bagmap');
INSERT INTO tb_type_place VALUES (null, 'Pet Shop', 'pet_store', 'google');
INSERT INTO tb_type_place VALUES (null, 'Restaurante', 'restaurant', 'bagmap');
INSERT INTO tb_type_place VALUES (null, 'Hotel', 'hotel', 'bagmap');
INSERT INTO tb_type_place VALUES (null, 'Parque de diversões', 'amusement_park', 'google');
INSERT INTO tb_type_place VALUES (null, 'Aquário', 'aquarium', 'google');
INSERT INTO tb_type_place VALUES (null, 'Caixa eletrônico', 'atm', 'google');
INSERT INTO tb_type_place VALUES (null, 'Banco', 'bank', 'google');
INSERT INTO tb_type_place VALUES (null, 'Salão de beleza', 'beauty_salon', 'google');
INSERT INTO tb_type_place VALUES (null, 'Estação de onibus', 'bus_station', 'google');
INSERT INTO tb_type_place VALUES (null, 'Área de camping', 'campground', 'google');
INSERT INTO tb_type_place VALUES (null, 'Aluguel de carros', 'car_rental', 'google');
INSERT INTO tb_type_place VALUES (null, 'Igreja', 'church', 'google');
INSERT INTO tb_type_place VALUES (null, 'Drogaria', 'drugstore', 'google');
INSERT INTO tb_type_place VALUES (null, 'Biblioteca', 'library', 'google');
INSERT INTO tb_type_place VALUES (null, 'Cinema', 'movie_theater', 'google');
INSERT INTO tb_type_place VALUES (null, 'Museu', 'museum', 'google');
INSERT INTO tb_type_place VALUES (null, 'Parque', 'park', 'google');
INSERT INTO tb_type_place VALUES (null, 'Estádio', 'stadium', 'google');
INSERT INTO tb_type_place VALUES (null, 'Estação de metrô', 'subway_station', 'google');
INSERT INTO tb_type_place VALUES (null, 'Atração turística', 'tourist_attraction', 'google');
INSERT INTO tb_type_place VALUES (null, 'Jardim zoológico', 'zoo', 'google');


-- -----------------------------------------------------
-- Table `db_maps`.`tb_user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_maps`.`tb_user` (
...
-- -----------------------------------------------------
-- Table `db_maps`.`tb_establishment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_maps`.`tb_establishment` (
  ...
  INDEX `fk_tb_user_professional_tb_establishment1_idx` (`id_user_establishment` ASC),
  CONSTRAINT `fk_tb_user_professional_tb_establishment1`
    FOREIGN KEY (`id_user_establishment`)
    REFERENCES `db_maps`.`tb_user_establishment` (`id_user`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `db_maps`.`tb_user_establishment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_maps`.`tb_user_establishment` (
  `id_user` INT NOT NULL,
  `name_user_establishment` VARCHAR(100) NOT NULL,
  `phone_user_establishment` VARCHAR(15) NOT NULL,
  `code` VARCHAR(3) NULL,
  `positions` VARCHAR(50) NOT NULL,
  INDEX `id_user_idx` (`id_user` ASC),
  PRIMARY KEY (`id_user`),
  CONSTRAINT `fk_user_user_professional`
    FOREIGN KEY (`id_user`)
    REFERENCES `db_maps`.`tb_user` (`id_user`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
--
INSERT INTO `tb_country` (`id_country`, `name`, `alpha_code`) VALUES ('1', 'Brasil', 'BRA');
...
-- -----------------------------------------------------
-- Table `db_maps`.`tb_address`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_maps`.`tb_address` (
  ...
  INDEX `fk_tb_address_tb_city_idx` (`id_city` ASC),
  CONSTRAINT `fk_adress_city`
    FOREIGN KEY (`id_city`)
    REFERENCES `db_maps`.`tb_city` (`id_city`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  INDEX `fk_tb_address_tb_state_idx` (`id_state` ASC),
  CONSTRAINT `fk_adress_state`
    FOREIGN KEY (`id_state`)
    REFERENCES `db_maps`.`tb_state` (`id_state`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `db_maps`.`tb_person`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_maps`.`tb_person` (
  `id_user` INT NOT NULL,
  `name_person` VARCHAR(100) NOT NULL,
  `date_birth` DATETIME NOT NULL,
  `gender` CHAR(2) NOT NULL,
  `phone_person` VARCHAR(20) NULL,
  `id_address` INT NOT NULL,
  INDEX `id_user_idx` (`id_user` ASC),
  PRIMARY KEY (`id_user`),
  INDEX `fk_tb_person_tb_address1_idx` (`id_address` ASC),
  CONSTRAINT `fk_user_person`
    FOREIGN KEY (`id_user`)
    REFERENCES `db_maps`.`tb_user` (`id_user`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_person_tb_address`
    FOREIGN KEY (`id_address`)
    REFERENCES `db_maps`.`tb_address` (`id_address`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `db_maps`.`tb_branch`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_maps`.`tb_branch` (
  `id_branch` INT NOT NULL AUTO_INCREMENT,
  `phone_branch` VARCHAR(20) NOT NULL,
  ...
  INDEX `fk_tb_branch_tb_establishment1_idx` (`id_establishment` ASC),
  INDEX `fk_tb_branch_tb_type` (`id_type_place` ASC),
  CONSTRAINT `fk_tb_branch_tb_establishment1`
    FOREIGN KEY (`id_establishment`)
    REFERENCES `db_maps`.`tb_establishment` (`id_establishment`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
CONSTRAINT `fk_tb_branch_type_place`
    FOREIGN KEY (`id_type_place`)
    REFERENCES `db_maps`.`tb_type_place` (`id_type_place`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `db_maps`.`tb_roles_user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_maps`.`tb_roles_user` (
  `id_roles` INT NOT NULL,
  `id_user` INT NOT NULL,
  `id_roles_user` INT NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id_roles_user`),
  INDEX `fk_tb_roles_has_tb_user_tb_user1_idx` (`id_user` ASC),
  INDEX `fk_tb_roles_has_tb_user_tb_roles1_idx` (`id_roles` ASC),
  CONSTRAINT `fk_tb_roles_has_tb_user_tb_roles1`
    FOREIGN KEY (`id_roles`)
    REFERENCES `db_maps`.`tb_roles` (`id_roles`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_roles_has_tb_user_tb_user1`
    FOREIGN KEY (`id_user`)
    REFERENCES `db_maps`.`tb_user` (`id_user`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `db_maps`.`tb_user_branch`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_maps`.`tb_user_branch` (
  `id_user` INT NOT NULL,
  `name_user_branch` VARCHAR(100) NOT NULL,
  `positions` VARCHAR(50) NOT NULL,
  `id_branch` INT NOT NULL,
  INDEX `fk_tb_user_branch_tb_branch1_idx` (`id_branch` ASC),
  PRIMARY KEY (`id_user`),
  CONSTRAINT `fk_tb_user_branch_tb_branch1`
    FOREIGN KEY (`id_branch`)
    REFERENCES `db_maps`.`tb_branch` (`id_branch`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_user_branch_tb_user1`
    FOREIGN KEY (`id_user`)
    REFERENCES `db_maps`.`tb_user` (`id_user`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `db_maps`.`tb_places`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_maps`.`tb_places` (
  ...
  INDEX `fk_tb_places_tb_person` (`id_user` ASC),
  INDEX `fk_tb_places_tb_type` (`id_type_place` ASC),
  CONSTRAINT `fk_places_person`
    FOREIGN KEY (`id_user`)
    REFERENCES `db_maps`.`tb_person` (`id_user`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_places_type_place`
    FOREIGN KEY (`id_type_place`)
    REFERENCES `db_maps`.`tb_type_place` (`id_type_place`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `db_maps`.`tb_image`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_maps`.`tb_image` (
  ...
  INDEX `fk_tb_image_tb_places2` (`id_places` ASC),
  INDEX `fk_tb_image_tb_branch` (`id_branch` ASC),
  CONSTRAINT `fk_places_images2`
    FOREIGN KEY (`id_places`)
    REFERENCES `db_maps`.`tb_places` (`id_places`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ibranch_image2`
    FOREIGN KEY (`id_branch`)
    REFERENCES `db_maps`.`tb_branch` (`id_branch`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `db_maps`.`tb_roadmaps`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_maps`.`tb_roadmaps` (
  `id_roadmaps` INT NOT NULL AUTO_INCREMENT,
  ...
  `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_roadmaps`),
  INDEX `fk_tb_roadmaps_tb_person` (`id_user` ASC),
  CONSTRAINT `fk_roadmaps_person`
    FOREIGN KEY (`id_user`)
    REFERENCES `db_maps`.`tb_person` (`id_user`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `db_maps`.`tb_placeroad`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_maps`.`tb_placeroad` (
  `id_placeroad` INT NOT NULL AUTO_INCREMENT,
  `id_place` TEXT NOT NULL,
  `type_id_place` VARCHAR(50) NOT NULL,
  `day` INT NOT NULL,
  `description` TEXT NULL,
  `id_roadmaps` INT NOT NULL,
  PRIMARY KEY (`id_placeroad`),
  INDEX `fk_tb_placeroad_tb_roadmaps` (`id_roadmaps` ASC),
  CONSTRAINT `fk_placeroad_roadmaps`
    FOREIGN KEY (`id_roadmaps`)
    REFERENCES `db_maps`.`tb_roadmaps` (`id_roadmaps`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

-- -----------------------------------------------------
-- Table `db_maps`.`tb_posts`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_maps`.`tb_posts` (
  ...
  INDEX `fk_tb_posts_tb_person` (`id_user` ASC),
...
-- Table `db_maps`.`tb_image`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_maps`.`tb_image_post` (
  `id_image` INT NOT NULL AUTO_INCREMENT,
  `link` TEXT NOT NULL,
  `id_posts` INT NULL,
  PRIMARY KEY (`id_image`),
  INDEX `fk_tb_image_post_tb_posts` (`id_posts` ASC),
  CONSTRAINT `fk_tb_image_post_tb_posts`
    FOREIGN KEY (`id_posts`)
    REFERENCES `db_maps`.`tb_posts` (`id_posts`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

        ...
        <Swiper style={styles.wrapper}
          ...
          <View style={styles.slideWrapper}>
            ...
            <View style={styles.slide1}>
              <View style={styles.containerImg}>
                ...
                <Image style={styles.img} source={require('../../../assets/imgFirstTip.png')} />
          ...
          <View style={styles.slideWrapper}>
            ...
            <View style={styles.slide2}>
              <View style={styles.containerImg}>
                <Image style={styles.img} source={require('../../../assets/imgSecondTip.png')} />
              </View>
          ...
          <View style={styles.slideWrapper}>
            ...
            <View style={styles.slide3}>
              <View style={styles.containerImg}>
                ...
                <Image style={styles.img} source={require('../../../assets/imgThirdTip.png')} />
